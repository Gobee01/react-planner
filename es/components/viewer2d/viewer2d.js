...
export default function Viewer2D(_ref, _ref2) {
  ...
  useEffect(() => {
    if (zoom && centerX && centerY) {
      viewer2DActions.updateCameraView({ a: zoom, b: 0, c: 0, d: zoom, e: centerX, f: centerY });
    }
  ...
  var onMouseDown = function onMouseDown(viewerEvent) {
    ...
    var _mapCursorPosition2 = mapCursorPosition(viewerEvent),
        ...
        cursorPosition(_mapCursorPosition2.x, _mapCursorPosition2.y)
